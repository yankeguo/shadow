...
# shadow UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# shadow UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# shadow UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of shadow
# `remote`  means remote server of shadow
...
from shadow import encrypt, obfs, eventloop, lru_cache, common, shell
from shadow.common import pre_parse_header, parse_header, pack_addr
