...
import getopt
import logging
from shadow.common import to_bytes, to_str, IPNetwork, PortRange
from shadow import encrypt
...
def __version():
    ...
    try:
        ...
        version_str = pkg_resources.get_distribution('shadow').version
    except Exception:
        try:
            from shadow import version
